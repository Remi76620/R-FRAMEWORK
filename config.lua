local Config <const> = {
    ...
    Color = {
        rgba = {r = 255, g = 0, b = 0, a = 255}, -- Yellow (https://htmlcolorcodes.com/fr/)
        hex = "#ff0000", -- Yellow (https://htmlcolorcodes.com/fr/)
        default = "~r~" -- Yellow (https://docs.fivem.net/docs/game-references/text-formatting/)
    },
    ...
    TogglePvp = true, -- Pvp
    ToggleNpcDrops = false, -- Drops des NPCs
    ToggleNpcHealthRegeneration = false, -- Regénération de la vie des NPCs
    ToggleDefaultWantedLevel = false, -- Niveau de désiré par défaut
    ToggleDispatchService = false, -- Service de dépêcheur
    ToggleScenarios = false, -- Scénarios
